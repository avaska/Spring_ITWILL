...
<div class="bodyWrap">		
	...
	<form action="timeLineWriteAction.ti" method="post" enctype="multipart/form-data" >
		<div class="writeTop">
		...
		<div class="writeBody">														
			...
			<textarea spellcheck="false" rows="40" cols="100" name="content" placeholder="사진은 최대 4장을 업로드할 수 있습니다." required></textarea>
